...
urlpatterns = [
    ...
    path("<uuid:pk>/withdraw/", views.property_withdraw, name="withdraw"),
    path("<uuid:pk>/restore/", views.property_restore, name="restore"),
    ...
    path("<uuid:pk>/listings/<uuid:listing_id>/pause/", views.listing_pause, name="listing_pause"),
    path("<uuid:pk>/listings/<uuid:listing_id>/discard/", views.listing_discard, name="listing_discard"),
